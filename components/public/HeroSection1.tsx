...
export function HeroSection() {
    ...
    return (
        ...
        <section className="fixed inset-0 bg-background min-h-screen flex items-end pb-16 px-6 overflow-hidden -z-10">
            {/* Subtle background gradient */}
            <div className="absolute inset-0 bg-gradient-to-br from-accent/5 via-transparent to-primary/5" />


            <div className="max-w-7xl mx-auto w-full flex flex-col-reverse lg:grid lg:grid-cols-2 gap-12 items-end relative z-10">
                {/* Left Content */}
